...
const Mrnmedicinelist = ({navigation}) => {
  return (
        ...
        <View style={styles.Box}>
          ...
          <View>
            ...
            <View style={styles.Row1}>
              <View style={styles.row1}></View>
              <View>
                <Text style={styles.Medi}>Paracetamol</Text>
              </View>
              <View>
            ...
            <View style={styles.Row1}>
              ...
              <View>
                <Text style={styles.medi}>x 4</Text>
              </View>
              <View style={styles.row2}>
                <View>
            ...
            <View style={styles.Row1}>
              ...
              <View>
                <Text style={styles.medi}>x 7</Text>
              </View>
              <View style={styles.row2}>
                <View>
                  <Text style={styles.Medi}>₹ 40.00</Text>
            ...
            <View style={styles.Row1}>
              ...
              <View>
                <Text style={styles.medi}>x 8</Text>
              </View>
              <View style={styles.row2}>
                <View>
                  <Text style={styles.Medi}>₹ 540.00</Text>
            ...
            <View style={styles.Row1}>
              ...
              <View>
                <Text style={styles.medi}>x 6</Text>
              </View>
              <View style={styles.row2}>
                <View>
                  <Text style={styles.Medi}>₹ 450.00</Text>
        ...
        <LinearGradient style={styles.btn} colors={['#00E0C5', '#009987']}>
          <TouchableOpacity>
            <View style={{alignItems: 'center', justifyContent: 'center'}}>
              <Text
                style={styles.btn1}
                onPress={() => navigation.navigate('MRNOrder')}>
                Confirm
              </Text>
            </View>
          </TouchableOpacity>
