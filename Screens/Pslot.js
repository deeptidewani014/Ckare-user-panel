    ...
    <View style={styles.container}>
      ...
      <View style={styles.Date}>
        <Text style={styles.date}>
          July, 2020 <Icon name="caretdown" style={styles.downicon} size={12} />
        </Text>
      </View>
      <View style={{alignItems: 'center'}}>
        <View style={styles.Row}>
          <View style={styles.col1}>
            <View>
              <Text style={styles.num1}>13</Text>
            </View>
          ...
          <TouchableOpacity>
            <LinearGradient
              ...
              <View style={styles.col2}>
                <View>
                  <Text style={styles.num12}>14</Text>
                </View>
                <View style={styles.Day1}>
                  <Text style={styles.day12}>TUE</Text>
                </View>
              </View>
            </LinearGradient>
          </TouchableOpacity>
          <View style={styles.col1}>
            <View>
              <Text style={styles.num1}>15</Text>
            </View>
            <View style={styles.Day1}>
              <Text style={styles.day1}>WED</Text>
            </View>
          </View>
          <View style={styles.col1}>
            <View>
            ...
            <View style={styles.Day1}>
              <Text style={styles.day1}>THUR</Text>
            </View>
          </View>
        </View>
      </View>
      ...
      <View>
        <Text style={styles.Available}>Available Time</Text>
      </View>
      ...
      <View style={{alignItems: 'center', justifyContent: 'space-between'}}>
        ...
        <View style={styles.Timetable}>
          ...
          <LinearGradient style={styles.Colcol} colors={['#00E0C5', '#009987']}>
            <View style={styles.Time}>
              <Text style={styles.timex}>12.30 AM</Text>
            </View>
          </LinearGradient>
        ...
        <View style={styles.Timetable}>
          ...
          <View style={styles.Time}>
            <Text style={styles.time}>04.30 AM</Text>
          </View>
          <View style={styles.Time}>
      ...
      <View>
        <Text style={styles.comment}>Write your problem</Text>
      </View>
