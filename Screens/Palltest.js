    ...
    <View style={styles.container}>
      ...
      <View style={styles.location}>
        <View style={styles.pinicon}>
          <Image source={require('../Assets/Image/pinicon.png')} />
        </View>
        <View style={styles.address}>
          <Text style={{fontSize: 16, color: '#37a987'}}>
            Patia, Bhubaneswar
          </Text>
        </View>
      </View>
      ...
      <TouchableOpacity style={styles.div2}>
        <View style={styles.thyroid}>
          <View style={styles.Row1}>
            <View>
              <Text style={styles.txt9}>Thyroid Stmulating Hormone (TSH)</Text>
            </View>
            <View>
              <Text style={styles.txt10}>
                Price : ₹ 350.00<Text style={styles.clr}> 10% off</Text>
        ...
        <LinearGradient style={styles.btn} colors={['#00E0C5', '#009987']}>
          <TouchableOpacity
            ...
            <View style={{alignItems: 'center', justifyContent: 'center'}}>
              <Text style={styles.btn1}>Book Now</Text>
            </View>
          </TouchableOpacity>
        </LinearGradient>
      </View>
