    ...
    <View style={styles.container}>
      ...
      <View style={styles.div1}>
        <View style={styles.col1}>
          <Image
            style={styles.img}
            source={require('../Assets/Image/Paracetamol2.png')}
          />
        </View>
        <View style={styles.col2}>
          <Text style={styles.txt1}>Paracetamol 500mg</Text>
          <Text style={styles.txt2}>
            ₹ 80.00 100<Text style={styles.clr}> 10% off</Text>
          </Text>
          <View style={styles.row}>
            <Text style={styles.txt3}>
              - 1<Text style={styles.clr}> +</Text>
            </Text>
        ...
        <LinearGradient style={styles.btn} colors={['#00E0C5', '#009987']}>
          <TouchableOpacity>
            <View style={styles.btn1}>
              <Text
                style={styles.btn2}
                onPress={() => navigation.navigate('Mordercart')}>
                Add to Cart
              </Text>
            </View>
          </TouchableOpacity>
