          ...
          <View style={styles.firstrowdiv}>
            <View>
              <Image
                ...
                source={require('../Assets/Image/Ellipse.png')}></Image>
            </View>
            <View style={{marginRight: 100}}>
              <Text>Mr. Mohanty</Text>
              <Image
                style={{height: 10, width: 70}}
                source={require('../Assets/Image/Group.png')}></Image>
            </View>
            <View>
              <Image
                style={{height: 35, width: 39}}
                source={require('../Assets/Image/circle.png')}></Image>
            </View>
          </View>

          <View style={styles.secondrowdiv}>
            <View style={{marginBottom: 20}}>
              <Text>Order Id: Ckare123456</Text>
            </View>
            ...
            <View style={styles.deliverytime}>
              <View
                ...
                <View>
                  <Image
                    ...
                    source={require('../Assets/Image/clock.png')}></Image>
                </View>
                <View>
              ...
              <View
                ...
                <View>
                  <Image
                    style={{height: 25, width: 23, marginRight: 10}}
                    source={require('../Assets/Image/home.png')}></Image>
                </View>
                <View>
                  <Text>Delivery Address</Text>
                  <Text>13 Nandan Vihar</Text>
                </View>
              </View>
            </View>
          </View>
