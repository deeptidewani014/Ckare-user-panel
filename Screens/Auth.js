        ...
        <LinearGradient
          ...
          <View style={styles.docdiv}>
            <View style={styles.image1div}>
              <Image
                style={styles.img1}
                source={require('../Assets/Image/doctorimg.png')}
              />
            </View>
          ...
          <View style={styles.Welcomediv}>
            <View style={styles.sdiv}>
              ...
              <Text style={styles.inserttext}>
                Insert your phone number to start
              </Text>
              ...
              <View style={styles.sdiv2}>
                ...
                {/* <TouchableOpacity>
                        <Text style={styles.startedbtn}  >Next Page</Text>
                    </TouchableOpacity> */}
                <View style={styles.icondiv}>
                  <TouchableOpacity>
                    <Icon1 name="google" style={styles.googleicon} size={35} />
                  </TouchableOpacity>
                  <TouchableOpacity>
                    <Icon2
                  ...
                  <TouchableOpacity>
                    <Icon3 name="apple1" style={styles.appleicon} size={27} />
                  </TouchableOpacity>
                </View>
              </View>
            </View>
